<template>
  <div class="header">
    ...
    <div class="navbar" v-if="!boardStatus">
      <router-link :to="{ name: 'board' }" class="board">게시판</router-link>
      |
      <router-link :to="{ name: 'project' }" class="project"
        >프로젝트</router-link
      >
    </div>
    <div class="navbar" v-else>
      <router-link :to="{ name: 'board' }" class="board-black"
        >게시판</router-link
      >
      |
      <router-link :to="{ name: 'project' }" class="project-black"
        >프로젝트</router-link
      >
    </div>
...
export default {
  computed: {
    ...
    ...mapState(projectStore, ["boardStatus"]),
  },
  methods: {
