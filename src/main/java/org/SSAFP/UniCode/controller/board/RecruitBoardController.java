...
public class RecruitBoardController {
	...
	public ResponseEntity<String> write(@RequestPart(value = "recruitBoard") RecruitBoard recruitBoard,
		...
		try {
			...
			// 글 작성
			recruitBoardService.writeArticle(recruitBoard);
			recruitBoardService.modifyRecruitInfo(recruitBoard);
			...
			if (language.getName().size() > 0) {
				...
				recruitBoardService.writeTag(tag);
			}
	...
	@PutMapping
	public ResponseEntity<String> modify(@RequestPart(value = "recruitBoard") RecruitBoard recruitBoard,
			@RequestPart(value = "language") Language language,
			@RequestPart(value = "upfile", required = false) MultipartFile[] files,
			@RequestPart(value = "upimage", required = false) MultipartFile[] images) throws Exception {
		...
		try {
			...
			// 글 수정
			recruitBoardService.deleteFileList(recruitBoard.getBid(), filePath, imagePath);
			recruitBoardService.modifyArticle(recruitBoard);
			recruitBoardService.modifyRecruitInfo(recruitBoard);
